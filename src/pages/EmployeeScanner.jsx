...
import { Camera, CameraOff, CheckCircle2, AlertTriangle, Clock, MapPin, RefreshCw, Smartphone, ShieldCheck, Play, UserCheck, Lock } from 'lucide-react';
...
export default function EmployeeScanner({ user, profile }) {
  ...
  // ============================================================================
  // CONDITIONAL RENDER: IF ACCOUNT IS PENDING VALIDATION BY ADMIN
  // ============================================================================
  if (profile && profile.status !== 'active') {
    return (
      <div className="max-w-xl mx-auto my-12 p-6 sm:p-8 bg-white border border-amber-200 rounded-3xl shadow-xl text-center space-y-6">
  ...
  // ============================================================================
  // ACTIVE EMPLOYEE SCANNER VIEW (LIGHT / WHITE THEME)
  // ============================================================================
  return (
    <div className="max-w-2xl mx-auto my-6 p-4 sm:p-6 space-y-6">
